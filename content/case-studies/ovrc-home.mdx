...
SnapAV had another initiative requiring OvrC Connect's launch to be paired with OvrC Pro, pushing the service model to get integrators charging for ongoing support. This didn't go as planned.

Most integrators had a hard time pitching the OvrC Pro device to end consumers and explaining that their expensive system wasn't going to be bulletproof. There was also confusion about whether OvrC Connect required the Pro device.
