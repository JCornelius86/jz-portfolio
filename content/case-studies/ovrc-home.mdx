...
*This shipped as OvrC Home and has since been renamed OvrC Connect. The story below uses
the name it carried while we built it.*
...
We also needed a way to showcase the dealer. An app was the obvious way to get this in customers' hands, but we couldn't name it after every integrator. We decided on **OvrC Home**, the name it carried until the later rebrand to **OvrC Connect**, and allowed dealers to upload their logo and brand info, making it feel like **their** app.
