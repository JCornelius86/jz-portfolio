...
Most of this work happened while I was managing, and the management was most of the job.

The team was six designers and UX researchers spread across Azure Advisor, CX Observe, and
the customer-health products. Three surfaces, one team, and never enough people to cover
all of it. So the job was deciding what each person owned and then getting out of the way.
I handed people whole workstreams instead of slices of mine, which is the only way six
people cover three products without every decision routing through one person.

The harder half was upstream of the team. Priorities arrived from several organizations at
once, ambiguous and sometimes contradictory, and converting that into a direction people
could actually execute against was the recurring problem. That meant building alignment
across product, engineering, research, and leadership, and making the team's work legible
to executives so it drew the investment it needed. Microsoft recognized the run with
**Azure X Manager of the Year**, for delivery results and people leadership.
